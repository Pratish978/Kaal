...
const BreathingCircle = () => {
  ...
  if (showChat) {
    return (
      <div className="fixed inset-0 z-[100] bg-[#FBF9F6] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-2 md:p-4 bg-[#FBF9F6]" suppressHydrationWarning>
      
      {/* Standard runtime keyframes standard fallback framework wrapper style matching perfectly on SSR/CSR */}
      ...
      <div className="bg-white rounded-[40px] md:rounded-[50px] w-full max-w-[900px] py-8 md:py-10 px-3 md:px-10 flex flex-col items-center overflow-hidden relative">
        ...
        {/* --- FIXED IMAGE WRAPPER AREA (SHADOW REMOVED) --- */}
        <div className="relative w-full flex flex-col items-center justify-center mb-10 overflow-visible min-h-[220px] md:min-h-[280px]">
          <div className={`relative z-10 transition-transform duration-[4000ms] ease-in-out ${
            ...
            <div className="w-[200px] h-[200px] md:w-[260px] md:h-[260px] relative rounded-full overflow-hidden shadow-none border-0 patch-no-shadow">
              <Image 
                src="/meditation.png" 
                alt="Meditation" 
                fill 
                className="object-cover border-none shadow-none outline-none" 
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none translate-y-13 md:translate-y-22">
            <div className="text-4xl md:text-xl font-bold text-white dropped-text-shadow">
              {breathsCompleted}/{breaths}
            </div>
            <div className="text-[10px] md:text-xs font-bold text-white uppercase tracking-[0.3em] md:tracking-[0.5em] mt-1 dropped-text-shadow">
            ...
            {currentShloka ? (
              <div className="text-center">
                <div className="flex justify-between items-start mb-6">
                  <span className="text-[10px] font-bold text-orange-400 uppercase tracking-widest">Verse {currentShloka.chapter}.{currentShloka.verse}</span>
